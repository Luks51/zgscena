    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ThemedText style={styles.description}>
          ...
          zanimljiv i atraktivan način predstaviti sve dionice orkestra te
          maestro koji tim orkestrom ravna. Kroz ovo predstavljanje najbolje će
          nas provesti ljubitelj klasične glazbe Borko Perić.
        </ThemedText>
